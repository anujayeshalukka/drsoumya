                ...
                <FieldWrap icon={<Phone size={15} color="#0d9488" />} label="Phone Number *" style={{ marginBottom: 16 }}>
                  <div style={{ display: 'flex', gap: 8 }}>
                    <div style={{ position: 'relative', width: '105px', flexShrink: 0 }}>
                      <select name="countryCode" value={form.countryCode} onChange={handleChange} style={{ ...inputStyle, width: '100%', padding: '12px 24px 12px 8px', appearance: 'none', WebkitAppearance: 'none' }}>
